 ...
 */
/**
 * La classe ContrainteDifferent.
 */
public class ContrainteDifferent implements Contrainte {
	 ...
	 */
	public ContrainteDifferent(Variable x1, Variable x2) {
	 ...
	 */
	public ContrainteDifferent(Variable x1, Integer val) {
		this.ensembleVariables = new ArrayList<Variable>();
		this.x1 = x1;
		this.setVal(val);
		this.ensembleVariables.add(x1);
	...
	public void explication(int a1, int a2) {
		System.out.println(a1 + " ne doit pas etre egal a " + a2 + " ,selon la contrainte " + this.toString());
