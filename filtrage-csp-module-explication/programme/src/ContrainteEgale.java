 ...
 */
/**
 * La classe ContrainteEgale.
 */
public class ContrainteEgale implements Contrainte {
	...
	/**
	 * Instancie une nouvelle contrainte egale binaire
	 *
	 * @param x1 la variable x1
	 * @param x2 la variable x2
	 */
	public ContrainteEgale(Variable x1, Variable x2) {
	 ...
	 */
	public ContrainteEgale(Variable x1, Integer val) {
		this.ensembleVariables = new ArrayList<Variable>();
		this.x1 = x1;
		this.setVal(val);
		this.ensembleVariables.add(x1);
	...
	public void explication(int a1, int a2) {
		System.out.println(a1 + " doit etre egal a " + a2 + " ,selon la contrainte " + this.toString());
