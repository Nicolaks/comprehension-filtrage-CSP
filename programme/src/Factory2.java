...
public class Factory2 {
	...
	public Factory2() {
		...
		this.C.add(contrainteNonSimultaneiteC10);
		this.C.add(contrainteIntegriteC1);
		this.C.add(contrainteAnterioriteC2);
		this.C.add(contrainteAnterioriteC3);
		this.C.add(contrainteAnterioriteC4);
		this.C.add(contrainteAnterioriteC5);

		this.C2.add(contrainteDemiJournee4C6);
		this.C2.add(contrainteDemiJournee4C7);
		this.C2.add(contrainteDemiJournee4C8);
		this.C2.add(contrainteDemiJournee4C9);
