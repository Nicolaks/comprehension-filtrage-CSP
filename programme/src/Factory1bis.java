 ...
 */
/**
 * la classe Factory1bis, un exemple qui ne fonctionne pas. x!y; y!=z; z!=w; 2
 * domaines differents
 */
public class Factory1bis {
	...
	public Factory1bis() {
		...
		ArrayList<Integer> listeValeursDomaine1 = new ArrayList<Integer>();
		listeValeursDomaine1.add(1);
		listeValeursDomaine1.add(2);
		listeValeursDomaine1.add(3);
		listeValeursDomaine1.add(4);

		ArrayList<Integer> listeValeursDomaine2 = new ArrayList<Integer>();
		listeValeursDomaine2.add(1);
		listeValeursDomaine2.add(2);
		listeValeursDomaine2.add(3);

		Domaine d1 = new Domaine(listeValeursDomaine1);
		Domaine d2 = new Domaine(listeValeursDomaine1);
		Domaine d3 = new Domaine(listeValeursDomaine1);
		Domaine d4 = new Domaine(listeValeursDomaine2);
