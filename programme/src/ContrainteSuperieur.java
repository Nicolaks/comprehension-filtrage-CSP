...
import src.Contrainte;

/**
 * @author 21203742 1603763
 */
/**
 * La classe ContrainteSuperieur.
 */
public class ContrainteSuperieur implements Contrainte {
	...
	/**
	 * Instancie une nouvelle contrainte superieur binaire
	 *
	 * @param x1 la variable x1
	 * @param x2 la variable x2
	 */
	public ContrainteSuperieur(Variable x1, Variable x2) {
	...
	/**
	 * Instancie une nouvelle contrainte superieur unaire.
	 *
	 * @param x1  la variable x1
	 * @param val la constante val
	 */
	public ContrainteSuperieur(Variable x_1, Integer val) {
		this.ensembleVariables = new ArrayList<Variable>();
		this.x1 = x_1;
		this.setVal(val);
		this.ensembleVariables.add(x_1);
		this.symbole = ">  var";
		this.setSymbole(symbole);
	}
	...
	public void explication(int a1, int a2) {
		System.out.println(a1 + " doit etre superieur a " + a2 + " ,selon la contrainte " + this.toString());
